...
public class RestTemplateServiceImpl implements RestTemplateService{
	...
	public String getName2() {
		...
		URI uri = UriComponentsBuilder
				...
				.encode()
				.build()
				.expand("frodo") //복수의 값을 넣어야할 경우 , 를 추가하여 구분
				.toUri();
	...
	public ResponseEntity<MemberDTO> postDto() {
		URI uri = UriComponentsBuilder
				...
				.queryParam("name", "crable")
				.queryParam("email", "crable@naver.com")
		...
		memberDTO.setName("frodo");
		memberDTO.setEmail("frodokang@gmail.com");
		memberDTO.setOrganization("hogwart");
